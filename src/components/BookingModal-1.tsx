...
export const BookingModal: React.FC<BookingModalProps> = ({
  ...
  const handleSubmitBooking = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // openWhatsAppAuto elige pestaña nueva en computador o redirección en la misma pestaña
      // en celular, porque los navegadores móviles bloquean window.open() después de un
      // "await" (ver el comentario en bookingLogic.ts para el detalle completo).
      openWhatsAppAuto(getWhatsAppBookingLink(result.cita));
    } catch (err: any) {
